...
if [ "${1:-}" = "--self-test" ]; then
  ...
  st_holds "the staged F front" "$ROOT/bin/lib/native-front/bin/fsub.ssc"
  st_holds "the F runner"       "$ROOT/bin/lib/native-front/bin/ssc1-run-fsub.ssc0"
  ...
  st_moves "the reference lowerer" "$ROOT/bin/lib/native-front/lib/ssc1-lower.ssc0"
  st_moves "the reference front"   "$ROOT/bin/lib/native-front/lib/ssc1-front.ssc0"
