...
Cross-refs:
- `specs/coroutines.md` — CPS / Free-monad infrastructure on JVM
- `specs/modularity.md` §12 — the bare-name leakage that this spec
  generalises from a textual to an architectural problem
- `specs/actors-dist.md` — actor / distributed semantics being
...
- **`Free[F, T]`**. Needs type-system support for effect rows
  ...
  `specs/coroutines.md` §v1.12. Out of scope.
...
- The v1.22 design itself (`specs/mapreduce.md`, `specs/actors-dist.md`).
