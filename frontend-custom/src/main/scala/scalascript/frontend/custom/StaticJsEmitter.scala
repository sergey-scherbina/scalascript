...
private[custom] object StaticJsEmitter:
  ...
  def emit(root: View, allComponents: List[ComponentDef]): String =
    ...
    sb ++= "// Generated by ScalaScript v1.18 — frontend-custom Phase A2 / A2b.\n"
    sb ++= "// Static + reactive (SignalText) emit.  Events/effects still in A2c+.\n"
  ...
  private final class Ctx:
     ...
     *  early). */
    private def registerSignal(signal: ReactiveSignal[String]): Unit =
