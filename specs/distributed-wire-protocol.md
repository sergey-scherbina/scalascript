...
Companion document: [`specs/distributed-runtime.md`](distributed-runtime.md)
...
|---------|---------------|-------------|
| Actor data plane | JSON text WebSocket frames in `specs/actors-dist.md` | Binary WS frames for `msg`, `link`, `monitor`, registry replies, pub/sub, and user messages |
