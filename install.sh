...
# `bin/lib/tower/` are READ AT RUNTIME, and editing a staged copy is the standard
...
# It must stay a COPY and never a symlink: `bin/lib/tower/` is read at runtime and
