...
Companion: [`docs/specs/typer-real-types-roadmap.md`](typer-real-types-roadmap.md)
...
7. **Dataset/Spark mapping integration** — partially landed 2026-05-26:
   ...
   `DatasetWirePartition` payloads through local actor workers. Follow-up
   landed 2026-05-26: `std/mapreduce` now exposes
