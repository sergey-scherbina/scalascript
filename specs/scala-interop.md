...
the existing ABI policy (see `specs/v2.0-artifact-format.md` §6).
...
- `specs/separate-compilation-plan.md` — the v2.0 separate-compilation
  pipeline this interop builds on.
- `specs/v2.0-artifact-format.md` — wire spec for `.scim` / `.scjvm`.
- `specs/v2.0-getting-started.md` — current end-user flow for the
  ScalaScript side.
