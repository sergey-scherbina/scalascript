...
Companion to [`docs/specs/backend-spi.md`](backend-spi.md) §8
...
MCP errors), and [`docs/specs/final-tagless.md`](final-tagless.md)
...
- `examples/mcp-agent.ssc` — uses both client and server in
  ...
  server)
- `docs/specs/mcp.md` updated with usage walkthroughs
