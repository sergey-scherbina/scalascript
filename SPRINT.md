...
- [ ] **scljet-m2a-readonly-spec** — before code, extend `specs/scljet.md` with exact public/internal
      APIs and errors for the 100-byte database header, page-size/reserved-byte validation, all four
      B-tree page kinds, cells/local-payload formulas, overflow/freelist/pointer-map traversal,
      record serial types/encodings/collations, schema decoding, read-only pager limits, and corpus
      fixtures. Commit the spec separately and keep mutation/SQL parsing out of M2.
- [ ] **scljet-m2b-page-record-codecs** — implement pure page-header/cell/varint payload and record
      codecs with localized corruption diagnostics, bounded overflow traversal, UTF-8/UTF-16
      decoding, and golden fixtures generated by official SQLite.
