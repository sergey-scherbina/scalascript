...
[`docs/specs/wallet-spi.md`](wallet-spi.md) §8 — wallet-spi, wallet-strategy-*,
...
- [`docs/specs/wallet-spi.md`](wallet-spi.md) — full wallet SPI design,
  source of the cross-compile intent in §8.
- [`docs/specs/blockchain-spi.md`](blockchain-spi.md) — the chain-side SPI
