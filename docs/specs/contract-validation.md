...
- [`docs/specs/typed-route-clients.md`](typed-route-clients.md)
- [`docs/specs/data-mapping.md`](data-mapping.md)
...
roadmap in [`docs/specs/typer-real-types-roadmap.md`](typer-real-types-roadmap.md).
