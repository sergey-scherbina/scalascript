...
class JvmGen(
    ...
    lockPath:         Option[os.Path] = None,
    frontendOverride: Option[String]  = None) extends JvmGenBlockAnalysis, JvmGenTermAnalysis, JvmGenMutualRecursion, JvmGenEffectAnalysis, JvmGenRuntimeSources, JvmGenCpsTransform, JvmGenMutualTco, JvmGenPreamble:
