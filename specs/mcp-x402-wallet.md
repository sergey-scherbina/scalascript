...
tools/resources/prompts protocol — see [`specs/mcp.md`](mcp.md)) with
...
- See [`specs/mcp.md`](mcp.md) for the in-project MCP design
- [`specs/x402.md`](x402.md) for HTTP x402 spec
- [`specs/wallet-spi.md`](wallet-spi.md) for wallet operations
- [`specs/blockchain-spi.md`](blockchain-spi.md) for chain ops
