...
> [`docs/specs/backend-spi.md`](backend-spi.md) and the landed Stage 1–9.1
...
| 6 | 6+     | 3 / 3           | **DONE** — msgpack framing (A) + InteractiveBackend/ir.Value (B) + HostCallback dispatch (C) |
