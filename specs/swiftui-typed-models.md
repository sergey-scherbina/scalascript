...
- Hot-reload / SwiftUI Previews (deferred per §2 of `specs/swiftui.md`).
...
`specs/typed-models-ir.md`. This SwiftUI document remains the backend-specific
...
Use `specs/typed-models-ir.md` as the canonical source for the shared `ModelDef`,
