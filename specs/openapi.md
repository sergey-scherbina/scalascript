...
**Companions:**
- [`specs/future-protocols.md §4`](future-protocols.md)
- [`specs/graphql.md`](graphql.md)
- [`specs/contract-validation.md`](contract-validation.md)
- [`specs/typer-real-types-roadmap.md`](typer-real-types-roadmap.md)
...
- **Replacing GraphQL introspection.** GraphQL has its own schema and
  introspection model; see [`specs/graphql.md`](graphql.md).
...
specified in [`specs/contract-validation.md`](contract-validation.md).
