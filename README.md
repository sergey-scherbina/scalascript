...
| Rozum / agent loop (`std.agent`) | `runAgent`, `AgentEndpoint`, `AgentTool`, `RunOptions`, `ToolResult` — OpenAI-compatible tool-call loop for stateless rozum gateways; apps own prompts, validation, and side effects |
