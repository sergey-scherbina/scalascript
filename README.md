...
| [distributed-dataset-typed-helpers.ssc](examples/distributed-dataset-typed-helpers.ssc) | Distributed Dataset typed helpers — `DistributedDataset.encode/decode[A]` around actor map + shuffle wire execution |
