...
| [content-introspection.ssc](examples/content-introspection.ssc) | Markdown-to-frontend authoring: Markdown body content, YAML data, section ids, and `contentToolkitNode()` composition with the `std/ui` toolkit |
