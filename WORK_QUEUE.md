...
- [x] **v1.50-native-p1-snakeyaml** — Replace snakeyaml with pure-Scala frontmatter parser (2026-05-27)
  _`scalascript.yaml.YamlParser` ~250 LOC; block+flow collections; scalar coercion; zero external deps; 22 new tests; all 616 tests green. Spec: `BACKLOG.md §Phase 1`._
