...
| [remote-registry-rpc.ssc](examples/remote-registry-rpc.ssc) | `remoteHandlers:` / `@remote` / `remote def` registry declarations, `Remote.function`, typed `remoteTryCall`, and HTTP JSON fallback path metadata |
