...
*13 entries matching `kind=perf status=open`, generated by `scripts/task-views` — do not edit inside the markers.*
...
| `front-ir-cache-switches-off-the-nested-f0-direct-asm-fast-path` | `v2/BUGS.md` | open | `tests/e2e/v2-f-nested-bytecode-fast-path.sh` |
...
| `v2-perf-cell-get-forces-effect-chain` | `v2/BACKLOG.md` | open | `bench/corpus/var-expr-init.ssc` |
