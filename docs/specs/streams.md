...
Companion to [`docs/specs/coroutines.md`](coroutines.md) (coroutine primitive and
one-shot fast path), [`docs/specs/algebraic-effects.md`](algebraic-effects.md)
(typed effect rows and capability passing), and [`docs/specs/mapreduce.md`](mapreduce.md)
...
See `docs/specs/tuple-monoid.md` for the full algebraic specification and the
