...
| [remote-registry-rpc.ssc](examples/remote-registry-rpc.ssc) | `remoteHandlers:` manifest registry, `Remote.function`, typed `remoteTryCall`, and HTTP JSON fallback path metadata |
