 ...
 *
 *  ARUDD return codes (from docs/international-bank-rails.md §v1.55.4):
 ...
 *
 *  See docs/international-bank-rails.md §7 (BACS DD) for full webhook taxonomy.
 */
 ...
 *  See docs/international-bank-rails.md §v1.55.4 for the full table.
 */
object AruddCode:
