...
hook at the app level — see [`specs/cluster-raft.md`](cluster-raft.md)
§5 for the shape.

Companion to [`specs/coroutines.md`](coroutines.md) §3.4
(v1.6 Phase 3 distributed actors — the foundation),
[`specs/mapreduce.md`](mapreduce.md) §11 (the explicit
...
See [`specs/cluster-raft.md`](cluster-raft.md) §6 for the unified
...
- **Sub-cluster federation** — the open question from §8.
  ...
  independent.  Federation needs its own `specs/cluster-federation.md`
...
- **Saga / distributed transactions** — coordinated multi-actor
  ...
  `specs/saga.md` before any code lands.  Logically belongs alongside
