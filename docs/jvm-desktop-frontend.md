...
no-socket path. `fetchTable` and typed clients remain planned.
...
success. Remaining work: connect `fetchTable` and typed client calls, and
decide whether the generated JVM path should share the interpreter
