...
| [SwiftUI / iOS / macOS](specs/swiftui.md) | V2 checked-CoreIR Swift/AppCore generation with a native SwiftUI observation/renderer layer and lifecycle-safe URLSession fetch/actions for macOS/iOS; Xcode app products, tables, persisted/online adapters, WKWebView, signing, and distribution remain staged |
