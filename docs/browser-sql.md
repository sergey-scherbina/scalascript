...
- **JDBC drivers in browsers.**  No Postgres / MySQL / Oracle from
  ...
  and points at `docs/postgres.md` for client-side network access.
...
4. **`docs/postgres.md`** — header note: "if you need Postgres from a
...
- [x] `docs/browser-sql.md` (this file).
