...
**Companions:**
- [`specs/openapi.md`](openapi.md)
- [`specs/graphql.md`](graphql.md)
- [`specs/typed-route-clients.md`](typed-route-clients.md)
- [`specs/data-mapping.md`](data-mapping.md)
...
roadmap in [`specs/typer-real-types-roadmap.md`](typer-real-types-roadmap.md).
