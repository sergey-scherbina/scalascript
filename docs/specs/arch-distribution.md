...
Companion specs: [`docs/specs/plugin-architecture.md`](plugin-architecture.md),
[`docs/specs/arch-build-registry.md`](arch-build-registry.md),
[`docs/specs/arch-sbt-plugin.md`](arch-sbt-plugin.md).
...
- `ssc new <name> --template plugin` minimal CLI scaffolding. ✓ Landed
  2026-05-29.
- Docs: new `docs/specs/community-plugins.md` walkthrough. ✓ Landed 2026-05-29.
