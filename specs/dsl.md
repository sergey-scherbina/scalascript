...
landed), [`specs/metaprogramming.md`](metaprogramming.md) (v1.14
`inline` + `derives` — useful for typed DSL ASTs but not
required), and [`specs/modularity.md`](modularity.md) §5 (the
...
`specs/backend-spi.md` §9 and partially landed.  v1.20 is about
...
### 5.1 Layout (per `specs/modularity.md` §5)
...
- `specs/dsl.md` status updated to shipped
