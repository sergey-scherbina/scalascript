...
the existing ABI policy (see `docs/specs/v2.0-artifact-format.md` §6).
...
- `docs/specs/separate-compilation-plan.md` — the v2.0 separate-compilation
  pipeline this interop builds on.
- `docs/specs/v2.0-artifact-format.md` — wire spec for `.scim` / `.scjvm`.
- `docs/specs/v2.0-getting-started.md` — current end-user flow for the
  ScalaScript side.
