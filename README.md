...
| [content-tables.ssc](examples/content-tables.ssc) | Use a Markdown GFM pipe table as `ContentBlock.Table`, print stable plain text/Markdown, and lower it through `contentToolkitBlock(id)` to a toolkit `TableNode` |
