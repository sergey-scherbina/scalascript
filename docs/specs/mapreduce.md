...
[`docs/specs/coroutines.md`](coroutines.md) (v1.10 generators for
...
(which is `docs/specs/cluster-management.md`).
...
down.  See `docs/specs/cluster-management.md` (deferred future
...
[`docs/specs/modularity.md` §12](modularity.md#12-technical-debt--jvmgen-inlineimport-bare-name-leakage)
...
| **Cluster management** | The `Cluster` handle is a thin wrapper for v1.22; the larger story (discovery, membership, leader election) lives in `docs/specs/cluster-management.md` deferred milestone. |
...
| **Implicit cluster discovery** | v1.22 takes an explicit `Cluster.connect(nodes…)`; auto-discovery is `docs/specs/cluster-management.md` territory |
...
[`docs/specs/cluster-management.md`](cluster-management.md), which
