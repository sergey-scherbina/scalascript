...
There is no `v3/BUGS.md`: a board exists only where something is in it, and the one defect v3 work
has found so far is `lane: multi` and lives at the [root](../BUGS.md).
