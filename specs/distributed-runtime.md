...
[`specs/distributed-wire-protocol.md`](distributed-wire-protocol.md). This spec
...
| `DStream[A].toLocalSource` | `specs/distributed-streams.md` | Specced, not implemented |
...
| Typed route clients | `specs/typed-route-clients.md`, `JvmGen.scala` | Partial |
| `WireCodec[A]` | `specs/distributed-wire-protocol.md`, `WORK_QUEUE.md` v1.62.1 | Planned |
...
- Add `cluster_spawn` / `cluster_spawn_ack` wire messages. ✓ Landed
  ...
  profiles remain under `specs/distributed-wire-protocol.md`.
...
- `specs/distributed-wire-protocol.md`
