...
Companion to [`specs/backend-spi.md`](backend-spi.md) (Layer 1,
...
2. **Bare-name top-level helpers don't resolve from inside the
   ...
   **Why option (a) didn't drop in cleanly** (attempted 2026-05-19,
   ...
   separately in `specs/dep-cps-rewrite.md`, which captures the
...
|-------|----------|--------|
| 1 (compiler/SPI) | [`specs/backend-spi.md`](backend-spi.md) | Landed |
| 1 (SPI followups) | [`specs/spi-followups-plan.md`](spi-followups-plan.md) | Landed |
| 3 (packaging) | v1.7 Tier 2 `.sscpkg` | Landed (commit `6605dc6`) |
| 2 (this doc) | **`specs/modularity.md`** | This document |
