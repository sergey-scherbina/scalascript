...
fixture="$ROOT/tests/conformance/v2-self-hosted-yaml-core.ssc"
expected="$ROOT/tests/conformance/expected/v2-self-hosted-yaml-core.txt"
tmp=$(mktemp -d "${TMPDIR:-/tmp}/ssc-v21-yaml-core.XXXXXX")
...
echo 'PASS v21-self-hosted-yaml-core-smoke'
