...
- [ ] **p4-perf-lazylist** — lazylist-take ~3560×: подозрение на квадратичность/
      пере-форс ленивых узлов в VM (LazyCons путь). Профилировать JFR-ом, чинить в ядре.
- [ ] **p4-perf-array-cells** — array-update ~386× и vector-index ~136×: массивы через
