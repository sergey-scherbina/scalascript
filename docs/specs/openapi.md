...
**Companions:**
- [`docs/specs/future-protocols.md §4`](future-protocols.md)
- [`docs/specs/graphql.md`](graphql.md)
...
- **Replacing GraphQL introspection.** GraphQL has its own schema and
  introspection model; see [`docs/specs/graphql.md`](graphql.md).
...
specified in [`docs/specs/contract-validation.md`](contract-validation.md).
