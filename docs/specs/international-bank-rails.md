...
- Close the explicit non-goals listed in `docs/specs/bank-rails.md §2`: add **SWIFT**,
...
Extends the table from `docs/specs/bank-rails.md §3.1`:
...
Mirrors `docs/specs/bank-rails.md §12`. Each adapter has:
