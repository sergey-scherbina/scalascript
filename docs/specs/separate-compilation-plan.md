...
user-facing tutorial is [`docs/specs/v2.0-getting-started.md`](v2.0-getting-started.md);
the wire-format spec is [`docs/specs/v2.0-artifact-format.md`](v2.0-artifact-format.md).
...
Iterations:
1. [x] Plan doc (`docs/specs/separate-compilation-plan.md`)
...
- **ABI compatibility test suite** — 64 forensic tests pin the
  ...
  on payload.  See `docs/specs/v2.0-artifact-format.md`.
...
- **User-facing getting-started tutorial** —
  [`docs/specs/v2.0-getting-started.md`](v2.0-getting-started.md):
...
- **Scale benchmark over real std/.**  ✓ Landed.  Bench runner at
  ...
  [`docs/specs/v2.0-scale-benchmark.md`](v2.0-scale-benchmark.md).
...
| 2026-05-19 | Phase 3 | – | TASTy-direct scalac driver (11.8× speedup); 64-test ABI compat suite; `docs/specs/v2.0-artifact-format.md`; `ssc verify` |
...
| 2026-05-19 | Phase 5 | landed | `--section-cache=interface` (Option B, body edits don't cascade); `ssc bundle --with-artifacts` + consumer-side `findArtifactAlongside` resolution; user-facing `docs/specs/v2.0-getting-started.md` |
