...
| [Distributed Runtime](docs/distributed-runtime.md) | Planned: canonical local/remote/distributed runtime model for streams, actors, typed async calls, cluster lifecycle, code deployment, and worker bundles |
...
| [Distributed runtime](docs/distributed-runtime.md) | Planned: `local` / `remote` / `distributed` placement vocabulary, named operation registry, code identity, stream bridges, typed actor remote spawn, `! Async` remote calls, cluster runner UX, and cluster-aware deployment |
