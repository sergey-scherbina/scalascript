...
hook at the app level — see [`docs/specs/cluster-raft.md`](cluster-raft.md)
§5 for the shape.

Companion to [`docs/specs/coroutines.md`](coroutines.md) §3.4
(v1.6 Phase 3 distributed actors — the foundation),
[`docs/specs/mapreduce.md`](mapreduce.md) §11 (the explicit
...
See [`docs/specs/cluster-raft.md`](cluster-raft.md) §6 for the unified
...
- **Sub-cluster federation** — the open question from §8.
  ...
  independent.  Federation needs its own `docs/specs/cluster-federation.md`
...
- **Saga / distributed transactions** — coordinated multi-actor
  ...
  `docs/specs/saga.md` before any code lands.  Logically belongs alongside
