...
Companion docs:
- [`specs/vm-jit-spec.md`](../specs/vm-jit-spec.md) — register VM + BytecodeJIT spec and end-to-end numbers
- [`specs/vm-jit-next.md`](../specs/vm-jit-next.md) — next optimization phases (Directions A–C backlog)
- [`specs/instancev-array-repr-spec.md`](../specs/instancev-array-repr-spec.md) — Direction B (InstanceV array repr)
...
[`specs/vm-jit-next.md`](../specs/vm-jit-next.md) and
