...
- `./ssc run bin/Mira.ssc0 examples/hm-eff-multiop.hm` => `"Int"`
- `./ssc run bin/ssctc-hm.ssc0 examples/hm-eff-multiop.hm > /tmp/mo48.coreir && ./ssc run-ir /tmp/mo48.coreir` => `42`
- `./ssc run bin/Mira-js.ssc0 examples/hm-eff-multiop.hm > /tmp/mo48.js && node /tmp/mo48.js | tail -1` => `42`
- `./ssc run bin/Mira-rust.ssc0 examples/hm-eff-multiop.hm > /tmp/mo48.rs && rustc -O /tmp/mo48.rs -o /tmp/mo48-bin && /tmp/mo48-bin` => `42`
