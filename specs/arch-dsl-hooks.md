...
in `BACKLOG.md`.
Companion: [`specs/dsl.md`](dsl.md), [`specs/plugin-architecture.md`](plugin-architecture.md),
...
- User-defined keywords at the parser level (a full-parser extension, not a
  preprocessor — out of scope, explicitly listed in `specs/dsl.md §9`).
...
- `quoted.Expr` / `quotes.reflect` macros (tracked separately in
  [`specs/metaprogramming.md`](metaprogramming.md) §1 as v2.x).
