...
- Hot-reload / SwiftUI Previews (deferred per §2 of `docs/specs/swiftui.md`).
...
`docs/specs/typed-models-ir.md`. This SwiftUI document remains the backend-specific
...
Use `docs/specs/typed-models-ir.md` as the canonical source for the shared `ModelDef`,
