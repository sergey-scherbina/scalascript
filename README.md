...
| [Placement and Remoting](docs/placement-and-remoting.md) | Planned: unified local/remote/distributed placement adapters for streams, actors, typed async functions/RPC, cluster code deployment, and worker bundles |
...
| [Placement and remoting](docs/placement-and-remoting.md) | Planned: `local` / `remote` / `distributed` placement vocabulary, named remote operation registry, cluster runner UX, code identity checks, stream adapters, actor remote spawn/proxies/groups, and typed async function RPC |
