...
| [markdown-toolkit-links.ssc](examples/markdown-toolkit-links.ssc) | Live `serve(page, 8099)` example where `textField`, `checkbox`, `button`, `signalText`, and `badge` controls are declared as ordinary Markdown `toolkit:` links instead of YAML |
