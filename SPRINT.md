...
- [ ] **scljet-m2b-page-record-codecs** — implement pure page-header/cell/varint payload and record
      codecs with localized corruption diagnostics, bounded overflow traversal, lossless
      UTF-8/UTF-16 byte preservation plus deterministic code-point projection, and golden fixtures
      generated by official SQLite.
