...
- **JDBC drivers in browsers.**  No Postgres / MySQL / Oracle from
  ...
  and points at `specs/postgres.md` for client-side network access.
...
4. **`specs/postgres.md`** — header note: "if you need Postgres from a
...
- [x] `specs/browser-sql.md` (this file).
