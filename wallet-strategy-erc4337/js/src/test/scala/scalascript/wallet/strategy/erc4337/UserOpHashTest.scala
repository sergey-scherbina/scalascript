 ...
 *  `CryptoBackend` (no `ServiceLoader` on JS).  Test bodies live in
 *  [[UserOpHashTestBase]] and run unchanged. */
class UserOpHashTest extends UserOpHashTestBase with BeforeAndAfterAll:
