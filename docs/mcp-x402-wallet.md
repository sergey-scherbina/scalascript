...
tools/resources/prompts protocol — see [`docs/mcp.md`](mcp.md)) with
...
- See [`docs/mcp.md`](mcp.md) for the in-project MCP design
- [`docs/x402.md`](x402.md) for HTTP x402 spec
- [`docs/wallet-spi.md`](wallet-spi.md) for wallet operations
- [`docs/blockchain-spi.md`](blockchain-spi.md) for chain ops
