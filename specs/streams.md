...
one-shot fast path), [`specs/algebraic-effects.md`](algebraic-effects.md)
(typed effect rows and capability passing), and [`specs/mapreduce.md`](mapreduce.md)
...
See `specs/tuple-monoid.md` for the full algebraic specification and the
