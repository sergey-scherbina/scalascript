...
`BACKLOG.md`.
Companion: [`docs/specs/plugin-architecture.md`](plugin-architecture.md).
...
- External plugin publication / Maven resolution (tracked separately in
  [`docs/specs/arch-distribution.md`](arch-distribution.md)).
...
- Update `docs/specs/plugin-architecture.md` to reflect new shape.
