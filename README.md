...
| [Client/server object store](docs/client-server-object-store.md) | Planned, partially implemented: JS/browser/Electron `IndexedDb.store[A]` typed local client store and JVM/JDBC `ObjectStore` have landed; generated REST sync remains planned |
