...
class JsGen(
    ...
    private[codegen] val reachableNames: Option[Set[String]] = None) extends JsGenAnalysisQueries, JsGenCpsCodegen:
  import scala.meta.*
...
""")
  ...
  def detectCapabilities(module: Module): Set[JsGen.Capability] =
    ...
    val hasUiHelpers = List(
      "fetchUrlSignal", "fetchAction", "fetchActionClear", "CaptureAction", "emptyHeaders",
