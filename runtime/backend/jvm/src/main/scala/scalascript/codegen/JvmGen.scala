...
class JvmGen(
    ...
    lockPath:         Option[os.Path] = None,
    frontendOverride: Option[String]  = None) extends JvmGenBlockAnalysis, JvmGenTermAnalysis, JvmGenMutualRecursion, JvmGenEffectAnalysis, JvmGenRuntimeSources, JvmGenCpsTransform:
...
""")
  ...
  private def canonicalCliqueMember(name: String): String =
  ...
  private def mergeableMutualClique(name: String): Boolean =
  ...
  private def emitMergedMutualClique(name: String): String =
