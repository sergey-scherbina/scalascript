...
function _httpSyncFetch(method, url, body, headers) {
  ...
  const workerSrc = [
    ...
    '    const opts = { method: workerData.method, headers: workerData.headers, signal: ac.signal, redirect: "manual" };',
...
function _httpStreamFetch(method, url, body, headers, handler) {
  ...
  const workerSrc = [
    ...
    '    const opts = { method, headers, signal: ac.signal, redirect: "manual" };',
