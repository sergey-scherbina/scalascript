...
[`specs/arch-build-registry.md`](arch-build-registry.md),
[`specs/arch-sbt-plugin.md`](arch-sbt-plugin.md).
...
- `ssc new <name> --template plugin` minimal CLI scaffolding. ✓ Landed
  2026-05-29.
- Docs: new `specs/community-plugins.md` walkthrough. ✓ Landed 2026-05-29.
