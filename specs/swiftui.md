...
- Hot-reload / SwiftUI Preview pipeline (requires Xcode build system; deferred to post-v1.0 per §19 of `specs/native-platform.md`).
...
[`specs/typed-models-ir.md`](typed-models-ir.md).  SwiftUI-specific detail:
[`specs/swiftui-typed-models.md`](swiftui-typed-models.md).
