...
private[vue] object VueEmitter:
  ...
  def emit(root: View): String =
    ...
    sb ++= "// Generated by ScalaScript v1.18 — frontend-vue Phase A5 / A2e.\n"
    sb ++= "// Signals + ReactiveSignalList lowered to ref(); same .ssc IR as Custom + React + Solid.\n"
    ...
    val allNames = signals.keys.toList ++ lists.keys.toList
    val returned =
