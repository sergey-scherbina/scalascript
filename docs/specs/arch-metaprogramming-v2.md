...
Prerequisite: [`docs/specs/arch-dsl-hooks.md`](arch-dsl-hooks.md) (DSL platform hooks, v1.x).
Existing v1.x surface: [`docs/specs/metaprogramming.md`](metaprogramming.md).

---

## 1. Scope decision recap

`docs/specs/metaprogramming.md §1` defines the v1.x boundary:
...
These are explicitly listed in `docs/specs/dsl.md §9` and will not be revisited:
