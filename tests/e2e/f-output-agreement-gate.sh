...
if [ "${1:-}" = "--self-test" ]; then
  ...
  st_holds "the staged F front" "$ROOT/bin/lib/tower/bin/fsub.ssc"
  st_holds "the F runner"       "$ROOT/bin/lib/tower/bin/ssc1-run-fsub.ssc0"
  ...
  st_moves "the reference lowerer" "$ROOT/bin/lib/tower/lib/ssc1-lower.ssc0"
  st_moves "the reference front"   "$ROOT/bin/lib/tower/lib/ssc1-front.ssc0"
