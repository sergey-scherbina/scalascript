...
- Close the explicit non-goals listed in `specs/bank-rails.md §2`: add **SWIFT**,
...
Extends the table from `specs/bank-rails.md §3.1`:
...
Mirrors `specs/bank-rails.md §12`. Each adapter has:
