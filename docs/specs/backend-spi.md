...
> live in [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md).
...
1. **Declaration in user space.** An `extern` modifier marks a
   ...
   **Handler shape:** intrinsics that accept user callbacks expect
   ...
   [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md) §2 for
...
the package over time.  See [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md)
...
- **Sync vs async handler semantics — RESOLVED.** Handlers return
  ...
  [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md) §2 and
...
- **Per-call-site dispatch in compiled backends — RESOLVED.**
  ...
  is `println`.  See [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md)
  §1.
- **`HostCallback` rollout — RESOLVED.** Build the dispatcher
  ...
  platform primitive.  See [`docs/specs/spi-intrinsics-design.md`](spi-intrinsics-design.md)
  §4.
...
- Two in-tree smoke-test plugins exercising both roles in CI without
  ...
  - a 50-line Scala-CLI SourceLanguage plugin for a trivial dialect
    ...
    fragment
- Document the protocol under `docs/specs/backend-spi-protocol.md`.
